...
func main() {
	...
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "  Claude Code (auto-detected if ~/.claude exists):")
	fmt.Fprintln(os.Stderr, "    tldt --install-skill          # Installs SKILL.md + hook + settings.json")
	fmt.Fprintln(os.Stderr, "    tldt --install-skill --target claude  # Force install")
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "  OpenCode (auto-detected if ~/.config/opencode exists):")
	fmt.Fprintln(os.Stderr, "    # Create directory first if it doesn't exist:")
	fmt.Fprintln(os.Stderr, "    mkdir -p ~/.config/opencode")
	fmt.Fprintln(os.Stderr, "    tldt --install-skill          # Auto-detects all assistants")
	fmt.Fprintln(os.Stderr, "    tldt --install-skill --target opencode  # Install to OpenCode only")
	fmt.Fprintln(os.Stderr, "    # Only SKILL.md is installed (no auto-trigger hook)")
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "  All assistants:")
	fmt.Fprintln(os.Stderr, "    tldt --install-skill --target all")
	fmt.Fprintln(os.Stderr, "")
